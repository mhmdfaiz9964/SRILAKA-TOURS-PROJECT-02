            ...
            <form action="{{ route('suppliers.index') }}" method="GET" class="row g-3 align-items-end">
                <div class="col-md-3">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" class="form-control form-control-sm ps-4 border-light rounded-3" placeholder="Name, Company...">
                    </div>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('suppliers.index') }}" class="btn btn-light btn-sm px-3 rounded-3 border-light">
                            <i class="fa-solid fa-rotate-right me-1"></i> Clear
                        </a>
                    </div>
                </div>
                <div class="col-12">
                    <div class="p-2 px-3 small fw-bold text-muted border-top pt-3">{{ $suppliers->total() }} Results</div>
                </div>
            </form>
        </div>
