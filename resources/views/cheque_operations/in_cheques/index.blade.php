                    ...
                    <div class="d-flex gap-2">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <ul class="dropdown-menu shadow-lg border-0 rounded-4 p-2 mt-2">
                                <li>
                                    <button type="submit" formaction="{{ route('in-cheques.export') }}" name="export" value="excel" class="dropdown-item d-flex align-items-center gap-2 rounded-3 p-2">
                                        <i class="fa-solid fa-file-excel text-success"></i> Excel Format
                                    </button>
                                </li>
                                <li>
                                    <button type="submit" formaction="{{ route('in-cheques.export') }}" name="export" value="pdf" class="dropdown-item d-flex align-items-center gap-2 rounded-3 p-2 mt-1">
