    ...
    <div class="container-fluid py-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            @can('out-cheque-create')
                <a href="{{ route('out-cheques.create') }}" class="btn btn-primary px-4 rounded-3 shadow-sm"
            ...
            <div class="p-3 border-bottom bg-light bg-opacity-10">
                <form action="{{ route('out-cheques.index') }}" method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select form-select-sm border-light rounded-3" name="sort">
                            ...
                            <option value="lowest_amount" {{ request('sort') == 'lowest_amount' ? 'selected' : '' }}>Lowest
                                Amount</option>
                            <option value="name_az" {{ request('sort') == 'name_az' ? 'selected' : '' }}>Payee Name (A-Z)
                            </option>
                        </select>
                    </div>
                    <div class="col-md-2">
                        ...
                        <select name="payee_name" class="form-select form-select-sm border-light rounded-3">
                            ...
                            @foreach($payees as $payee)
                                <option value="{{ $payee }}" {{ request('payee_name') == $payee ? 'selected' : '' }}>{{ $payee }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" id="daterange-out" class="form-control form-control-sm border-light rounded-3"
                    ...
                    <div class="col-md-2">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('out-cheques.index') }}"
                            ...
                            <div class="dropdown d-inline-block">
                                ...
                                <ul class="dropdown-menu shadow-lg border-0 rounded-4 p-2 mt-2">
                                    <li>
                                        <button type="submit" formaction="{{ route('out-cheques.export') }}" name="export"
                                            value="excel"
                            ...
                            @forelse($cheques as $cheque)
                                <tr>
                                    <td class="ps-4"><input type="checkbox" name="cheque_ids[]" value="{{ $cheque->id }}"
                                            class="cheque-checkbox"></td>
                                    <td>
                                        <span class="badge rounded-pill px-2 py-1"
                                            style="background: #fff7ed; color: #f97316; font-size: 0.65rem;">
                                            OUT
                                        </span>
                                    </td>
                                    <td class="small text-muted">
                                        {{ \Carbon\Carbon::parse($cheque->cheque_date)->format('d/m/Y') }}</td>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="d-flex justify-content-end gap-1">
                                            @can('out-cheque-edit')
                                                <a href="{{ route('out-cheques.edit', $cheque) }}"
