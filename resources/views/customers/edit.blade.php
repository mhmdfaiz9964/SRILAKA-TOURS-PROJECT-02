...
<div class="container-fluid">
    <div class="content-header mb-4">
        <h1 class="h3 fw-bold text-gray-800">Edit Customer</h1>
    </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('customers.update', $customer->id) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="mobile_number" class="form-label fw-bold small">Mobile Number <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ $customer->status ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-5">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-5" style="background: #6366f1; border: none;">Update Customer</button>
                        </div>
                    </form>
                </div>
            </div>
