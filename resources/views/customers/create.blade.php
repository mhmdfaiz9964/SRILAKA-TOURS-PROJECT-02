...
<div class="container-fluid">
    <div class="content-header mb-4">
        <h1 class="h3 fw-bold text-gray-800">Add New Customer</h1>
    </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('customers.store') }}" method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-5">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-5" style="background: #6366f1; border: none;">Save Customer</button>
                        </div>
                    </form>
                </div>
            </div>
