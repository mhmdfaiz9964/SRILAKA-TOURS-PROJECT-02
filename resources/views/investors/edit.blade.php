    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="fw-bold mb-0">Edit Investor: {{ $investor->name }}</h4>
                    <p class="text-muted small">Update existing investment details in the system.</p>
                </div>
                        ...
                        <div class="row g-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" name="invest_amount" class="form-control border-light bg-light shadow-none @error('invest_amount') is-invalid @enderror" value="{{ old('invest_amount', $investor->invest_amount) }}" required>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light border-light text-muted small">LKR</span>
                                            <input type="number" step="0.01" name="expect_profit" class="form-control border-light bg-light shadow-none @error('expect_profit') is-invalid @enderror" value="{{ old('expect_profit', $investor->expect_profit) }}" required>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light border-light text-muted small">LKR</span>
                                            <input type="number" step="0.01" name="paid_profit" class="form-control border-light bg-light shadow-none @error('paid_profit') is-invalid @enderror" value="{{ old('paid_profit', $investor->paid_profit) }}">
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="collect_date" class="form-control border-light bg-light rounded-3 shadow-none @error('collect_date') is-invalid @enderror" value="{{ old('collect_date', $investor->collect_date) }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="refund_date" class="form-control border-light bg-light rounded-3 shadow-none @error('refund_date') is-invalid @enderror" value="{{ old('refund_date', $investor->refund_date) }}">
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea name="notes" class="form-control border-light bg-light rounded-3 shadow-none" rows="4" placeholder="Any additional details or special conditions...">{{ old('notes', $investor->notes) }}</textarea>
                                </div>
                            </div>
