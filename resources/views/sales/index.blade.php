                        ...
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="rounded-circle d-flex align-items-center justify-content-center"
                                    style="width: 32px; height: 32px; background: #fff; color: #3b82f6;">
                                    <i class="fa-solid fa-sack-dollar"></i>
                                </div>
                            </div>
                            <div class="h4 fw-bold mb-0" style="color: #1e40af;">LKR {{ number_format($totalSales, 2) }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4" style="background: #fff7ed;">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="rounded-circle d-flex align-items-center justify-content-center"
                                    style="width: 32px; height: 32px; background: #fff; color: #f97316;">
                    ...
                    <div class="card border-0 shadow-sm rounded-4" style="background: #fef2f2;">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="rounded-circle d-flex align-items-center justify-content-center"
                                    style="width: 32px; height: 32px; background: #fff; color: #ef4444;">
                                    <i class="fa-solid fa-clock"></i>
                                </div>
                            </div>
                            <div class="h4 fw-bold mb-0" style="color: #991b1b;">LKR {{ number_format($pendingAmount, 2) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-3 border-bottom bg-light bg-opacity-10">
                    <form action="{{ route('sales.index') }}" method="GET" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="dropdown">
                                <button
                                    class="btn btn-sm btn-light border bg-white dropdown-toggle w-100 text-start d-flex justify-content-between align-items-center rounded-3 shadow-none"
                                    type="button" data-bs-toggle="dropdown" aria-expanded="false" style="min-height: 31px;">
                                    Select Status
                                </button>
                                <ul class="dropdown-menu p-2 w-100 border-0 shadow-lg rounded-3">
                                    <li><label class="dropdown-item d-flex align-items-center gap-2 cursor-pointer"
                                    ...
                                    <li><label class="dropdown-item d-flex align-items-center gap-2 cursor-pointer"
                                            onclick="event.stopPropagation()">
                                            <input type="checkbox" name="status[]" value="partial" class="form-check-input"
                                                {{ in_array('partial', (array) request('status')) ? 'checked' : '' }}>
                                            <span>Partial</span>
                                        </label></li>
                                    <li><label class="dropdown-item d-flex align-items-center gap-2 cursor-pointer"
                                            onclick="event.stopPropagation()">
                                            <input type="checkbox" name="status[]" value="unpaid" class="form-check-input"
                                                {{ in_array('unpaid', (array) request('status')) ? 'checked' : '' }}>
                                            <span>Unpaid</span>
                                        </label></li>
                                </ul>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="date" name="start_date" class="form-control border-light rounded-3 shadow-none"
                                    value="{{ request('start_date') }}">
                                <span class="input-group-text bg-transparent border-0 text-muted">-</span>
                                <input type="date" name="end_date" class="form-control border-light rounded-3 shadow-none"
                                ...
                                @forelse($sales as $sale)
                                    <tr class="cursor-pointer" onclick="window.location='{{ route('sales.show', $sale->id) }}'">
                                        ...
                                        <td class="small">
                                            @if($sale->status == 'paid')
                                                <span
                                                    class="badge bg-success-subtle text-success rounded-pill border border-0">Paid</span>
